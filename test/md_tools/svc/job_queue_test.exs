defmodule MdTools.Svc.JobQueueTest do
  ...
  #     assert {:ok, _pid} = start_supervised({JobQueue, []})
  #   end
  #
  #   test "start_supervised without args" do
  #     assert {:ok, _pid} = start_supervised(JobQueue)
  #   end
  #
  #   test "with start_supervised!" do
  #     assert _pid = start_supervised!({JobQueue, []})
  #   end
  #
  #   test "registered process name" do
  #     start_supervised({JobQueue, []})
  #     assert Process.whereis(JobQueue)
  #   end
  # end
  #
